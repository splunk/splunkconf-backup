...
* in your cloned repo, click on "Settings" under the repo then "Secrets and Variables" then "Actions" then select "Variables"
* click on "New Repository Variable" button (that appeared green on top right)
