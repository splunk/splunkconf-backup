...
- cloud limit reached (like number of resources allowed for your account) -> ask for increased limit 
- insufficient network resources (ip) in the specified network -> check and increase network size if applicable
