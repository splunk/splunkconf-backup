...
resource "null_resource" "bucket_sync" {
  ...
  depends_on = [null_resource.build-idx-scripts, null_resource.build-bobidx-scripts, aws_s3_bucket_lifecycle_configuration.s3_install_lifecycle, aws_s3_bucket_lifecycle_configuration.s3_backup_lifecycle, aws_s3_bucket_versioning.s3_install_versioning, aws_s3_bucket_versioning.s3_backup_versioning]
}
