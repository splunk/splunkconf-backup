...
output "subnet_pub_1_id" {
  ...
  value = var.create_network_module ? aws_subnet.subnet_pub_1[0].id : 0
}

output "subnet_pub_2_id" {
  description = "Subnet Pub 2 id"
  value = var.create_network_module ? aws_subnet.subnet_pub_2[0].id : 0
}

output "subnet_pub_3_id" {
  description = "Subnet Pub 3 id"
  value = var.create_network_module ? aws_subnet.subnet_pub_3[0].id : 0
}

output "subnet_priv_1_id" {
  description = "Subnet Priv 1 id"
  value = var.create_network_module ? aws_subnet.subnet_priv_1[0].id : 0
}

output "subnet_priv_2_id" {
  description = "Subnet Priv 2 id"
  value = var.create_network_module ? aws_subnet.subnet_priv_2[0].id : 0
}

output "subnet_priv_3_id" {
  description = "Subnet Priv 3 id"
  value = var.create_network_module ? aws_subnet.subnet_priv_3[0].id : 0
}
